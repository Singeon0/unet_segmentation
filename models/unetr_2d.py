...
def main_unetr(N1, train_images, train_labels, valid_images, valid_labels, epoch, batch_size, optimizer, loss, filename_charts):
    config = {}
    ...
    try:
        ...
        print(history_model_unet.history.keys())
        pass
